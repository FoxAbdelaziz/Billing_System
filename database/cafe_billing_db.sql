...
--
-- Host: 127.0.0.1
-- Generation Time: 01 يونيو 2023 الساعة 16:50
...
(4, 'تذاكر المرضي', 'تذاكر المرضي بفئات معية ');
...
(3, '658363782669', 5, 5, 1, '2023-05-31 19:55:10'),
(5, '255786835796', 5, 5, 1148868129, '2023-05-31 21:01:40');
...
(5, 4, 'تذكرة فئة 5 جنية ', 'تذكرة فئة 5 جنية  مصري فقط لا غير', 5, 1);
...
(3, 'Abdelaziz', '3140', '0192023a7bbd73250516f069df18b500', 2);
